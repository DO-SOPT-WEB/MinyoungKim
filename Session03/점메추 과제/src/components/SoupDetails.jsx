...
const SoupDetailsPage = ({ BackButtonKey, ForthButtonKey, selectYesSoup, selectNoSoup}) => {
    ...
    return (
        <Container>
            <div>
                ...
                <ButtonContainer>
                    <YesSoupButton type="button" onClick={YesSoup} soup={soup}><p>국물 있음</p></YesSoupButton>
                    <NoSoupButton type="button" onClick={NoSoup} soup={soup}><p>국물 없음</p></NoSoupButton>
                </ButtonContainer>

                <ButtonContainer>
                    <BackButton type="button" onClick={BackButtonKey}>이전으로</BackButton>
                    <ForthButton disabled={!isSoupSelected} onClick={ForthButtonKey} isSoupSelected={isSoupSelected}>결과보기</ForthButton>
                </ButtonContainer>
            </div>
        </Container>
    );
