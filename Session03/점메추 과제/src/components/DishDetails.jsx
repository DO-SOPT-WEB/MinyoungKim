    ...
    return(
        <Container>
            <div>
                ...
                <ButtonContainer>
                    <RiceDishButton type ="button" onClick={RiceDish} dish={dish}><p>밥</p></RiceDishButton>
                    <NoodleDishButton type="button" onClick={NoodleDish} dish={dish}><p>면</p></NoodleDishButton>
                    <MeatFishDishButton type="button" onClick={MeatFishDish} dish={dish}><p>고기or해물</p></MeatFishDishButton>
                </ButtonContainer>

                <ButtonContainer>
                    <BackButton type="button" onClick={BackButtonKey}>이전으로</BackButton>
                    <ForthButton disabled={!isDishSelected} onClick={ForthButtonKey} isDishSelected={isDishSelected}>다음으로</ForthButton>
                </ButtonContainer>
